------------------------------------------------
-- This Source Was Developed By (Rio) @eueeee.--
--   This Is The Source Channel @E5EEEF .   --
--                - Dove -                 --
--        -- https://t.me/E5EEEF --         --
------------------------------------------------ 
...
./tg -s ./Dove.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,2044593457,1879100340,2044593457}
Dove = Config.Dove
...
if File_Name ~= "Dove.lua" then 
send(chat,msg.id_," ᥀︙هذا الملف ليس تابع لسورس داف")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/getfile?file_id='..ID_FILE) ) 
os.execute('rm -rf Dove.lua')
...
local UserName = (dp.username_ or "E5EEEF")
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/Song:"..data.sender_user_id_}},{{text="᥀ Dove Source .",url="t.me/E5EEEF"}}} 
...
᥀︙م6 ↫ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙[Source Channel](https://t.me/E5EEEF)
]] 
keyboard = {} 
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'E5EEEF')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'E5EEEF')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ᥀','↫ تحديث ᥀'},
{'↫ السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ᥀'},
{'↫ المشتركين ᥀','↫ المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ᥀'},
{'↫ اذاعه خاص ᥀','↫ اذاعه عام ᥀'},
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ الاوامر الخدميه  ᥀'},
{'↫ اوامر النسب ᥀','↫ البوتات ᥀'},
{'↫ العاب ᥀'},
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس داف فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس داف فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
{'↫ الالعاب ᥀','↫ كت ᥀'},
{'↫ سمايلات ᥀','↫ معاني ᥀'},
{'↫ ترتيب ᥀','↫ حزوره ᥀'},
...
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "E5EEEF")}},
{{text="᥀ السورس .",url="https://t.me/E5EEEF"},{text="᥀ لتنصيب بوت .",url="https://t.me/eueeee"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "E5EEEF")..')', 1, 'md') 
...
{{text = '᥀ Delete face',url="https://www.facebook.com/help/deleteaccount"},{text = '᥀ Delete insta',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent"}},{{text= '᥀ Dove Source',url="https://t.me/E5EEEF"}}
}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/E5EEEF")}}}
local msg_id = msg.id_/2097152/0.5
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@E5EEEF]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@E5EEEF]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Dove Source     --
--        Contact         --
...
Text = [[
᥀︙[مبرمج السورس](https://t.me/eueeee)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/eueeee&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Dove Source     --
...
Text = [[
Welcome To Source
᥀︙[Dove Source](https://t.me/E5EEEF)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/E5EEEF"}},
{{text = '᥀ Developer',url="t.me/eueeee"},{text = '᥀ Tws Dove',url="https://t.me/L3LSBot"}},{{text= '᥀ Exp Source',url="https://t.me/EEE5EF"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/E5EEEF&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Dove Source     --
...
if tonumber(result.id_) == tonumber(2044593457) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(2044593457) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or E5EEEF}}}
local msg_id = msg.id_/2097152/0.5
...
local Text ='*᥀︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/Song:"..msg.sender_user_id_}},{{text = '᥀ Dove Source .',url="t.me/E5EEEF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/E5EEEF' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "E5EEEF")..")"
else 
...
Text = [[
᥀︙[قناة السورس](https://t.me/E5EEEF)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/E5EEEF"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/E5EEEF&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙جاري تحديث سورس داف', 1, 'md') 
os.execute('rm -rf Dove.lua') 
os.execute('wget https://raw.githubusercontent.com/SourceDove/Dove/main/Dove.lua') 
dofile('Dove.lua') 
